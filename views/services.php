                ...
                foreach ($params as $parm){
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="/updateService?service_id=<?php echo $parm['service_id']?>" target="_blank" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                Edit
                            </a>
                        </td>
                    </tr>
